...
Weekly Demand Forecasting Using SQL is a data analytics project that analyzes historical sales data and predicts future weekly demand using SQL queries and forecasting techniques.
...
Compare Results at both product and portfolio levels.
Formulate Recommendations based on empirical evidence.
📊 Evaluation & Results
...
About
This project presents a SQL-first, reproducible approach to weekly demand forecasting for the Top-10 products by sales volume. Using 26 weeks of transactional data, a complete weekly demand series (including zero-demand weeks) was constructed.
...
1
@royalhemesh
royalhemesh ponthala hemesh babu
Languages
Jupyter Notebook
100.0%
Footer
